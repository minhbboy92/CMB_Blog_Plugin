...
if (!class_exists('\Plugin\CMBlog\Entity\BlogImage')) {
    /**
     * BlogImage
     *
     ...
     * @ORM\Entity(repositoryClass="\Plugin\CMBlog\Repository\BlogImageRepository")
     */
    class BlogImage extends \Eccube\Entity\AbstractEntity
    {
         ...
         *
         * @ORM\ManyToOne(targetEntity="\Plugin\CMBlog\Entity\Blog", inversedBy="BlogImage")
         * @ORM\JoinColumns({
